	  		...
	  		<table class="form-table">
	  			<tbody>
	  				<tr valign="top">
	  					...
	  					<td>
							<ol>
								<li><?php echo sprintf( __( 'Sign up on the homepage at <a href="%s" target="_blank">www.addsearch.com</a>.', 'addsearch' ), 'http://www.addsearch.com/' ); ?></li>
								<li><?php _e( 'Wait for the confirmation email that tells you your search is available.', 'addsearch' ); ?></li>
								<li><?php _e( 'Click the link to your search demo in the email. Click on <strong>Install Now</strong>, and sign up into the AddSearch Dashboard.', 'addsearch' ); ?></li>
								<li><?php _e( 'Click <strong>Installation</strong>, scroll to the bottom of the page, and copy the Site Key.', 'addsearch' ); ?></li>
								<li><?php _e( 'Come back to this page WordPress. Paste your Site Key above and click <strong>Save Changes</strong>.', 'addsearch' ); ?></li>
